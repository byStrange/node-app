var setREVStartSize = function () {
                                                                    try {
                                                                        ...
                                                                        if (e.responsiveLevels && (jQuery.each(e
                                                                            ...
                                                                            .gridheight[l] || e.gridheight[0] || e
                                                                            .gridheight, s = e.gridwidth[l] || e
                                                                            .gridwidth[0] || e.gridwidth, h = i / s,
                                                                            h = h > 1 ? 1 : h, f = Math.round(h *
                                                                            ...
                                                                            if (void 0 != e
                                                                                ...
                                                                                if (c) jQuery.each(c, function (e,
                                                                                        ...
                                                                                        "%").length > 1 && void 0 !=
                                                                                    e.fullScreenOffset && e
                                                                                    .fullScreenOffset.length > 0 ?
                                                                                    u -= jQuery(window).height() *
                                                                                    parseInt(e.fullScreenOffset,
                                                                                        0) / 100 : void 0 != e
                                                                                    .fullScreenOffset && e
                                                                                    .fullScreenOffset.length > 0 &&
                                                                                    (u -= parseInt(e
                                                                        ...
                                                                        console.log(
                                                                            "Failure at Presize of Slider:" + d)
                                                                    }
                                                                };
                                                                ...
                                                                tpj(document).ready(function () {
                                                                    if (tpj("#rev_slider_5_2").revolution ==
                                                                        undefined) {
                                                                        revslider_showDoubleJqueryError(
                                                                            "#rev_slider_5_2");
                                                                    } else {
                                                                        revapi5 = tpj("#rev_slider_5_2").show()
                                                                            .revolution({
                                                                                sliderType: "standard",
                                                                                ...
                                                                                gridwidth: [1300, 1024, 778,
                                                                                    480
                                                                                ],
                                                                                gridheight: [610, 430, 300,
                                                                                    250
                                                                                ],
                                                                                lazyType: "none",
                                                                                shadow: 0,
